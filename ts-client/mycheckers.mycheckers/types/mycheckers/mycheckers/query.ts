...
export const protobufPackage = "mycheckers.mycheckers";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("mycheckers.mycheckers.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  SystemInfo(request: QueryGetSystemInfoRequest): Promise<QueryGetSystemInfoResponse> {
    const data = QueryGetSystemInfoRequest.encode(request).finish();
    const promise = this.rpc.request("mycheckers.mycheckers.Query", "SystemInfo", data);
  ...
  StoredGame(request: QueryGetStoredGameRequest): Promise<QueryGetStoredGameResponse> {
    ...
    const promise = this.rpc.request("mycheckers.mycheckers.Query", "StoredGame", data);
  ...
  StoredGameAll(request: QueryAllStoredGameRequest): Promise<QueryAllStoredGameResponse> {
    ...
    const promise = this.rpc.request("mycheckers.mycheckers.Query", "StoredGameAll", data);
